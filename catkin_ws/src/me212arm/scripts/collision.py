...
def in_collision(q, obstacle_segs):
    ...
    a = intersect(obstacle_segs[0][0],obstacle_segs[0][1],arm_segments[0][0],arm_segments[0][1])
    b = intersect(obstacle_segs[0][0],obstacle_segs[0][1],arm_segments[1][0],arm_segments[1][1])
    return a or b
